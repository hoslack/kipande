...
<div class="reports">
    ...
    <div class="submitform" >
        ...
        <fieldset class="searchfield">
        	...
        	<legend>Search Certificates by Institution</legend>

        <form method="POST" action="certbyinstitution.php">
...
if(isset($_POST['search']))
{
	...
	$qresult=mysqli_query($conn,"SELECT * FROM certificates WHERE institution like '%$searchq%'");

     $output = "<table id='listtable'>
<tr> 
<th>First Name</th><th>Middle Name</th><th>Last Name</th> <th>Certificate Number</th> <th>Institution</th> <th>Centre</th>
<th>Status</th>
</tr>";
    ...
    $output= $output."<tr> <td>" .$fname. "</td> <td> ".$mname."</td> <td> ".$lname. "</td> <td> ".$certnumber. "</td> <td> ".$institution. "</td> <td> ".$centre."</td> <td> ".$status. "</td> </tr>";
		}
$output=$output."</table>";
