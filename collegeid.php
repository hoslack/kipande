...
<ul id="navbar">
	...
	<li id="navbar"><a href="collegeid.php" class="active">College ID</a></li>
...
if(isset($_POST['search']))
{
	...
	$qresult=mysqli_query($conn,"SELECT * FROM collegeid WHERE fname LIKE '%$searchq%' OR lname LIKE '%$searchq%' OR idnumber LIKE '%$searchq%' OR mname LIKE '%$searchq%' ORDER BY fname ASC");
...
?>
       ...
       <div class="submitform" >
        ...
        <form method="POST" action="collegeid.php">
