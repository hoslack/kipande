...
<ul id="navbar">
	...
	<li id="navbar"><a href="bankcards.php" class="active">Banking Cards</a></li>
...
if(isset($_POST['search']))
{
	...
	$qresult=mysqli_query($conn,"SELECT * FROM bankcards WHERE fname LIKE '%$searchq%' OR lname LIKE '%$searchq%' OR cardnumber LIKE '%$searchq%' OR mname LIKE '%$searchq%' ORDER BY fname ");

$output = "<table id='listtable'>
<tr> 
<th>First Name</th><th>Middle Name</th><th>Last Name</th><th>Card Number</th> <th>Card Type</th> <th>Service Provider</th> <th>Centre</th> <th>Collected</th> 
</tr>";
	...
	$output= $output."<tr>  <td>".$fname."</td> <td>".$mname."</td> <td>".$lname."</td> <td>".$cardnumber."</td> <td>".$cardtype."</td> <td>".$sprovider."</td> <td>".$centre."</td> <td>".$Status."</td> </tr>";
		}
$output=$output."</table>";
...
?>
       ...
       <div class="submitform" >
        ...
        <form method="POST" action="bankcards.php">
